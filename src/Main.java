...
public class Main {
    public static void main(String[] args) {
        ...
        curso1.setDescricao("Exemplo descrição do curso Java");
        curso1.setCargaHoraria(8);

        Curso curso2 = new Curso();
        curso2.setTitulo("Curso JavaScript");
        curso2.setDescricao("Exemplo descrição do curso JavaScript");
        curso2.setCargaHoraria(4);

        Mentoria mentoria = new Mentoria();
        mentoria.setTitulo("Mentoria de Java");
        mentoria.setDescricao("Exemplo descrição da mentoria de Java");
        ...
        bootcamp.setDescricao("Exemplo descrição do Bootcamp Java Developer");
